  ...
  const owaspItems = [
    {
      ...
      risk: "High",
      desc: "Маніпуляція контекстом моделі через приховані інструкції користувача для обходу системних правил.",
    ...
    },
    {
      ...
      risk: "High",
      desc: "Витік системного промпту, конфіденційних API-ключів або PII-даних через навідні запитання користувача.",
    ...
    },
    {
      ...
      risk: "Critical",
      desc: "Надання моделі доступу до деструктивних функцій файлової системи або бази даних без попередньої авторизації.",
      remedy: "Принцип найменших привілеїв (Least Privilege), обов'язкове підтвердження дій людиною (Human-in-the-Loop).",
    },
  ];
